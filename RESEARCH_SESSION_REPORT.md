...
| Events analyzed | 0 |
| Sessions analyzed | 0 |
| Average research depth (0–100) | 0.0 |
| Repeat topic rate | 0.0% |
| Compare usage rate | 0.0% |
| Save → return rate | 0.0% |
| Citation workflow completion rate | 0.0% |
| Collection revisit rate | 0.0% |
| Avg query chain length | 0.00 |
| Avg topic chain length | 0.00 |
| Shallow SEO proxy (bounce + casual) | 0.0% |
| Serious research proxy (explorer + researcher + repeat) | 0.0% |
...
| bounce | 0 | 0.0% |
| casual_lookup | 0 | 0.0% |
| active_explorer | 0 | 0.0% |
| researcher | 0 | 0.0% |
| repeat_researcher | 0 | 0.0% |
