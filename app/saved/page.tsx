...
export const metadata: Metadata = {
  title: "Spoken knowledge library",
  description: `${PRODUCT_TAGLINE} Bookmarked transcript moments on this device — grouped for quick research revisits.`,
  ...
  return (
    <PageShell>
      ...
      <section className="rounded-3xl border border-white/10 bg-white/5 p-4 sm:p-8">
        <h1 className="text-3xl font-semibold text-white">Your spoken knowledge library</h1>
